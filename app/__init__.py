...
from app.exams.models import Exam, ExamTakers

DATABASE.create_tables([School, User, Lesson, LessonStudent, Lecture, Discussion, Note, Question, Reply, Exam, ExamTakers], safe=True)
